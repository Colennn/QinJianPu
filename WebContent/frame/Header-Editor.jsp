...
<html ng-app="musjeDemo">
  <head>
    ...
    <link href="<%=basePath %>editor-bin/demo/lib/codemirror/codemirror.css" rel="stylesheet">
	<link href="<%=basePath %>editor-bin/lib/addon/codemirror/musje-codemirror.css" rel="stylesheet">
	<link href="<%=basePath %>editor-bin/lib/musje.css" rel="stylesheet">
